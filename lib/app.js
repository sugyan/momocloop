...
app.configure(function () {
    ...
    app.use(express.session({
        ...
        store: (function () {
            ...
            var parsed_url  = url.parse(process.env.npm_package_config__connect_redis_url || 'http://localhost:6379');
    ...
    app.redisClient = function () {
        var parsed_url  = url.parse(process.env.npm_package_config__redis_url || 'redis://127.0.0.1:6379');
        var parsed_auth = (parsed_url.auth || '').split(':');
